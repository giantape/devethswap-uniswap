...
import Logo from '../../assets/images/deveth_logo.png'
import LogoDark from '../../assets/images/deveth_logo.png'
            ...
            <AccountElement active={!!account} style={{ pointerEvents: 'auto' }}>
              {account && userEthBalance ? (
                <BalanceText style={{ flexShrink: 0 }} pl="0.75rem" pr="0.5rem" fontWeight={500}>
                  {userEthBalance?.toSignificant(4)} {chainId === 787 ?? 'DTH'}
                </BalanceText>
              ) : null}
              <Web3Status />
            </AccountElement>
