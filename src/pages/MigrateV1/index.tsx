...
export default function MigrateV1() {
  ...
  const V1LiquidityTokens: Token[] = useMemo(() => {
    return chainId
      ? Object.keys(V1Exchanges).map(exchangeAddress => new Token(chainId, exchangeAddress, 18, 'UNI-V1', 'DevEthereum-Swap V1'))
      : []
  }, [chainId, V1Exchanges])
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        ...
        <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
          For each pool shown below, click migrate to remove your liquidity from DevEthereum-Swap V1 and deposit it into DevEthereum-Swap
          V2.
        </TYPE.body>
